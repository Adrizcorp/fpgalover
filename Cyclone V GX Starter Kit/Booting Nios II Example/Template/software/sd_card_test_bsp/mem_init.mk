...
$(MEM_0)_START := 0x40141000
$(MEM_0)_END := 0x401417ff
...
$(MEM_1)_START := 0x40120000
$(MEM_1)_END := 0x4013f3ff
...
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_2)_lane0.dat
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_2)_lane1.dat
SYM_FILES += $(HDL_SIM_DIR)/$(MEM_2).sym
HDL_SIM_INSTALL_FILES += $(HDL_SIM_INSTALL_DIR)/$(MEM_2).sym
$(MEM_2)_START := 0x40080000
$(MEM_2)_END := 0x400fffff
$(MEM_2)_SPAN := 0x00080000
$(MEM_2)_HIERARCHICAL_PATH := sram
$(MEM_2)_WIDTH := 16
$(MEM_2)_HEX_DATA_WIDTH := 16
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 1

.PHONY: sram
sram: check_elf_exists $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
