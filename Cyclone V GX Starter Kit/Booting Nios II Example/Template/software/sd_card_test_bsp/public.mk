...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../C5G_LPDDR2_Nios_Test.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../C5G_QSYS.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x401420a8
SOPC_SYSID_FLAG += --sidp=0x401420a8
ELF_PATCH_FLAG  += --sidp 0x401420a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1483316685
SOPC_SYSID_FLAG += --timestamp=1483316685
ELF_PATCH_FLAG  += --timestamp 1483316685
